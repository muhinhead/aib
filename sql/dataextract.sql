...
select c.contact_id,
       ...
       sf1.sub_feature_name as sub_feature_name1,
  ...
  from contacts c left outer join aib_titles t on c.contact_title=t.title_id
                  ...
                  left outer join contactfeatures cf1 on (c.contact_id=cf1.pf_contact_id and 
                                  (cf1.pf_feature_id between 60 and 326 or cf1.pf_feature_id in (366,378,379,398)))
