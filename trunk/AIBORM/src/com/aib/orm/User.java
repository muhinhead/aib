...
//        }
    ...
    public void delete() throws SQLException, ForeignKeyViolationException {
        ...
        if (Reportform.exists(getConnection(),"owner_id = " + getUserId())) {
            throw new ForeignKeyViolationException("Can't delete, foreign key violation: reportform_user_fk");
        }
    ...
    public void setIsAdmin(Integer isAdmin) throws SQLException, ForeignKeyViolationException {
        if (null != isAdmin)
            isAdmin = isAdmin == 0 ? null : isAdmin;
