...
public class Company extends DbObject  {
    ...
    public Company(Connection connection) {
        ...
        setColumnNames(new String[]{"company_id", "full_name", "is_dummy", "abbreviation", "logo", "turnover", "address", "mailaddress", "country_id", "main_phone", "main_fax", "member_level", "renewal_date", "verify_date", "comments", "lastedited_by", "lastedit_date"});
    }

    public Company(Connection connection, Integer companyId, String fullName, Integer isDummy, String abbreviation, Object logo, Double turnover, String address, String mailaddress, Integer countryId, String mainPhone, String mainFax, Integer memberLevel, Date renewalDate, Date verifyDate, String comments, Integer lasteditedBy, Timestamp lasteditDate) {
        super(connection, "company", "company_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT company_id,full_name,is_dummy,abbreviation,logo,turnover,address,mailaddress,country_id,main_phone,main_fax,member_level,renewal_date,verify_date,comments,lastedited_by,lastedit_date FROM company WHERE company_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                company.setLasteditedBy(new Integer(rs.getInt(16)));
                company.setLasteditDate(rs.getTimestamp(17));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO company ("+(getCompanyId().intValue()!=0?"company_id,":"")+"full_name,is_dummy,abbreviation,logo,turnover,address,mailaddress,country_id,main_phone,main_fax,member_level,renewal_date,verify_date,comments,lastedited_by,lastedit_date) values("+(getCompanyId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE company " +
                    "SET full_name = ?, is_dummy = ?, abbreviation = ?, logo = ?, turnover = ?, address = ?, mailaddress = ?, country_id = ?, main_phone = ?, main_fax = ?, member_level = ?, renewal_date = ?, verify_date = ?, comments = ?, lastedited_by = ?, lastedit_date = ?" + 
            ...
            try {
                ...
                ps.setObject(15, getLasteditedBy());
                ps.setObject(16, getLasteditDate());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT company_id,full_name,is_dummy,abbreviation,logo,turnover,address,mailaddress,country_id,main_phone,main_fax,member_level,renewal_date,verify_date,comments,lastedited_by,lastedit_date FROM company " +
    ...
    public Object[] getAsRow() {
        ...
        columnValues[15] = getLasteditedBy();
        columnValues[16] = getLasteditDate();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setComments(flds[14]);
        try {
            setLasteditedBy(Integer.parseInt(flds[15]));
        } catch(NumberFormatException ne) {
            setLasteditedBy(null);
        }
        setLasteditDate(toTimeStamp(flds[16]));
    }
}
