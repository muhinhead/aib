...
public class People extends DbObject  {
    ...
    public People(Connection connection) {
        ...
        setColumnNames(new String[]{"people_id", "title", "first_name", "last_name", "suffix", "greeting", "location_id", "photo", "level", "job_discip", "department", "spec_address", "mailaddress", "desk_phone", "desk_fax", "mobile_phone", "main_email", "alter_email", "pa", "pa_phone", "pa_email", "other_contacts", "is_primary", "is_subscriber", "is_marketintl", "is_mediabrief", "is_insourcebook", "verify_date", "sales_contact_id", "action_date", "next_action", "external_user", "external_passwd", "lastedited_by", "lastedit_date"});
    }

    public People(Connection connection, Integer peopleId, String title, String firstName, String lastName, String suffix, String greeting, Integer locationId, Object photo, String level, String jobDiscip, String department, String specAddress, String mailaddress, String deskPhone, String deskFax, String mobilePhone, String mainEmail, String alterEmail, String pa, String paPhone, String paEmail, String otherContacts, Integer isPrimary, Integer isSubscriber, Integer isMarketintl, Integer isMediabrief, Integer isInsourcebook, Date verifyDate, Integer salesContactId, Date actionDate, String nextAction, String externalUser, String externalPasswd, Integer lasteditedBy, Timestamp lasteditDate) {
        super(connection, "people", "people_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT people_id,title,first_name,last_name,suffix,greeting,location_id,photo,level,job_discip,department,spec_address,mailaddress,desk_phone,desk_fax,mobile_phone,main_email,alter_email,pa,pa_phone,pa_email,other_contacts,is_primary,is_subscriber,is_marketintl,is_mediabrief,is_insourcebook,verify_date,sales_contact_id,action_date,next_action,external_user,external_passwd,lastedited_by,lastedit_date FROM people WHERE people_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                people.setIsInsourcebook(new Integer(rs.getInt(27)));
                people.setVerifyDate(rs.getDate(28));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO people ("+(getPeopleId().intValue()!=0?"people_id,":"")+"title,first_name,last_name,suffix,greeting,location_id,photo,level,job_discip,department,spec_address,mailaddress,desk_phone,desk_fax,mobile_phone,main_email,alter_email,pa,pa_phone,pa_email,other_contacts,is_primary,is_subscriber,is_marketintl,is_mediabrief,is_insourcebook,verify_date,sales_contact_id,action_date,next_action,external_user,external_passwd,lastedited_by,lastedit_date) values("+(getPeopleId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE people " +
                    "SET title = ?, first_name = ?, last_name = ?, suffix = ?, greeting = ?, location_id = ?, photo = ?, level = ?, job_discip = ?, department = ?, spec_address = ?, mailaddress = ?, desk_phone = ?, desk_fax = ?, mobile_phone = ?, main_email = ?, alter_email = ?, pa = ?, pa_phone = ?, pa_email = ?, other_contacts = ?, is_primary = ?, is_subscriber = ?, is_marketintl = ?, is_mediabrief = ?, is_insourcebook = ?, verify_date = ?, sales_contact_id = ?, action_date = ?, next_action = ?, external_user = ?, external_passwd = ?, lastedited_by = ?, lastedit_date = ?" + 
            ...
            try {
                ...
                ps.setObject(26, getIsInsourcebook());
                ps.setObject(27, getVerifyDate());
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new People(con,new Integer(rs.getInt(1)),rs.getString(2),rs.getString(3),rs.getString(4),rs.getString(5),rs.getString(6),new Integer(rs.getInt(7)),rs.getObject(8),rs.getString(9),rs.getString(10),rs.getString(11),rs.getString(12),rs.getString(13),rs.getString(14),rs.getString(15),rs.getString(16),rs.getString(17),rs.getString(18),rs.getString(19),rs.getString(20),rs.getString(21),rs.getString(22),new Integer(rs.getInt(23)),new Integer(rs.getInt(24)),new Integer(rs.getInt(25)),new Integer(rs.getInt(26)),new Integer(rs.getInt(27)),rs.getDate(28),new Integer(rs.getInt(29)),rs.getDate(30),rs.getString(31),rs.getString(32),rs.getString(33),new Integer(rs.getInt(34)),rs.getTimestamp(35)));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public Object[] getAsRow() {
        ...
        columnValues[26] = getIsInsourcebook();
        columnValues[27] = getVerifyDate();
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        try {
            setIsInsourcebook(Integer.parseInt(flds[26]));
        } catch(NumberFormatException ne) {
            setIsInsourcebook(null);
        }
        setVerifyDate(toDate(flds[27]));
        try {
