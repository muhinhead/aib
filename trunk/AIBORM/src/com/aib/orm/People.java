// Generated by com.aib.orm.tools.dbgen.DbGenerator.class at Sat Feb 15 21:17:00 FET 2014
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                people.setVerifyDate(rs.getDate(30));
                people.setSalesContactId(new Integer(rs.getInt(31)));
                people.setActionDate(rs.getDate(32));
                people.setNextAction(rs.getString(33));
                people.setExternalUser(rs.getString(34));
                people.setExternalPasswd(rs.getString(35));
                people.setLasteditedBy(new Integer(rs.getInt(36)));
                people.setLasteditDate(rs.getTimestamp(37));
                people.setIsInvoiceCntct(new Integer(rs.getInt(38)));
                people.setIsDigitalChnl(new Integer(rs.getInt(39)));
                people.setNew(false);
            }
        } finally {
            try {
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            try {
                ...
                ps.setObject(29, getVerifyDate());
                ps.setObject(30, getSalesContactId());
                ps.setObject(31, getActionDate());
                ps.setObject(32, getNextAction());
                ps.setObject(33, getExternalUser());
                ps.setObject(34, getExternalPasswd());
                ps.setObject(35, getLasteditedBy());
                ps.setObject(36, getLasteditDate());
                ps.setObject(37, getIsInvoiceCntct());
                ps.setObject(38, getIsDigitalChnl());
                ps.execute();
            } finally {
                if (ps != null) ps.close();
            }
    ...
    public Object[] getAsRow() {
        ...
        columnValues[29] = getVerifyDate();
        columnValues[30] = getSalesContactId();
        columnValues[31] = getActionDate();
        columnValues[32] = getNextAction();
        columnValues[33] = getExternalUser();
        columnValues[34] = getExternalPasswd();
        columnValues[35] = getLasteditedBy();
        columnValues[36] = getLasteditDate();
        columnValues[37] = getIsInvoiceCntct();
        columnValues[38] = getIsDigitalChnl();
        return columnValues;
    }
    ...
    public void fillFromString(String row) throws ForeignKeyViolationException, SQLException {
        ...
        setVerifyDate(toDate(flds[29]));
        try {
            setSalesContactId(Integer.parseInt(flds[30]));
        } catch(NumberFormatException ne) {
            setSalesContactId(null);
        }
        setActionDate(toDate(flds[31]));
        setNextAction(flds[32]);
        setExternalUser(flds[33]);
        setExternalPasswd(flds[34]);
        try {
            setLasteditedBy(Integer.parseInt(flds[35]));
        } catch(NumberFormatException ne) {
            setLasteditedBy(null);
        }
        setLasteditDate(toTimeStamp(flds[36]));
        try {
            setIsInvoiceCntct(Integer.parseInt(flds[37]));
        } catch(NumberFormatException ne) {
            setIsInvoiceCntct(null);
        }
        try {
            setIsDigitalChnl(Integer.parseInt(flds[38]));
        } catch(NumberFormatException ne) {
