...
public class People extends DbObject  {
    ...
    public People(Connection connection) {
        ...
        setColumnNames(new String[]{"people_id", "source", "title", "first_name", "last_name", "suffix", "greeting", "location_id", "photo", "level", "job_discip", "department", "spec_address", "mailaddress", "desk_phone", "desk_fax", "mobile_phone", "main_email", "alter_email", "pa", "pa_phone", "pa_email", "other_contacts", "is_primary", "is_subscriber", "is_marketintl", "is_mediabrief", "is_insourcebook", "verify_date", "sales_contact_id", "action_date", "next_action", "external_user", "external_passwd", "lastedited_by", "lastedit_date"});
    }

    public People(Connection connection, Integer peopleId, String source, String title, String firstName, String lastName, String suffix, String greeting, Integer locationId, Object photo, String level, String jobDiscip, String department, String specAddress, String mailaddress, String deskPhone, String deskFax, String mobilePhone, String mainEmail, String alterEmail, String pa, String paPhone, String paEmail, String otherContacts, Integer isPrimary, Integer isSubscriber, Integer isMarketintl, Integer isMediabrief, Integer isInsourcebook, Date verifyDate, Integer salesContactId, Date actionDate, String nextAction, String externalUser, String externalPasswd, Integer lasteditedBy, Timestamp lasteditDate) {
        super(connection, "people", "people_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT people_id,source,title,first_name,last_name,suffix,greeting,location_id,photo,level,job_discip,department,spec_address,mailaddress,desk_phone,desk_fax,mobile_phone,main_email,alter_email,pa,pa_phone,pa_email,other_contacts,is_primary,is_subscriber,is_marketintl,is_mediabrief,is_insourcebook,verify_date,sales_contact_id,action_date,next_action,external_user,external_passwd,lastedited_by,lastedit_date FROM people WHERE people_id=" + id;
        try {
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO people ("+(getPeopleId().intValue()!=0?"people_id,":"")+"source,title,first_name,last_name,suffix,greeting,location_id,photo,level,job_discip,department,spec_address,mailaddress,desk_phone,desk_fax,mobile_phone,main_email,alter_email,pa,pa_phone,pa_email,other_contacts,is_primary,is_subscriber,is_marketintl,is_mediabrief,is_insourcebook,verify_date,sales_contact_id,action_date,next_action,external_user,external_passwd,lastedited_by,lastedit_date) values("+(getPeopleId().intValue()!=0?"?,":"")+"?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public void save() throws SQLException, ForeignKeyViolationException {
        if (isNew()) {
            ...
            String stmt =
                    "UPDATE people " +
                    "SET source = ?, title = ?, first_name = ?, last_name = ?, suffix = ?, greeting = ?, location_id = ?, photo = ?, level = ?, job_discip = ?, department = ?, spec_address = ?, mailaddress = ?, desk_phone = ?, desk_fax = ?, mobile_phone = ?, main_email = ?, alter_email = ?, pa = ?, pa_phone = ?, pa_email = ?, other_contacts = ?, is_primary = ?, is_subscriber = ?, is_marketintl = ?, is_mediabrief = ?, is_insourcebook = ?, verify_date = ?, sales_contact_id = ?, action_date = ?, next_action = ?, external_user = ?, external_passwd = ?, lastedited_by = ?, lastedit_date = ?" + 
