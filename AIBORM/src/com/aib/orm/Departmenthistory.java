...
public class Departmenthistory extends DbObject  {
    ...
    public Departmenthistory(Connection connection) {
        ...
        setColumnNames(new String[]{"departmenthistory_id", "people_id", "until_date"});
    }

    public Departmenthistory(Connection connection, Integer departmenthistoryId, Integer peopleId, Date untilDate) {
        super(connection, "departmenthistory", "departmenthistory_id");
...
//        }
    ...
    public DbObject loadOnId(int id) throws SQLException, ForeignKeyViolationException {
        ...
        ResultSet rs = null;
        String stmt = "SELECT departmenthistory_id,people_id,until_date FROM departmenthistory WHERE departmenthistory_id=" + id;
        try {
            ...
            if (rs.next()) {
                ...
                departmenthistory.setUntilDate(rs.getDate(3));
    ...
    protected void insert() throws SQLException, ForeignKeyViolationException {
         ...
         PreparedStatement ps = null;
         String stmt =
                "INSERT INTO departmenthistory ("+(getDepartmenthistoryId().intValue()!=0?"departmenthistory_id,":"")+"people_id,until_date) values("+(getDepartmenthistoryId().intValue()!=0?"?,":"")+"?,?)";
         try {
             ps = getConnection().prepareStatement(stmt);
             int n = 0;
    ...
    public static DbObject[] load(Connection con,String whereCondition,String orderCondition) throws SQLException {
        ...
        PreparedStatement ps = null;
        ResultSet rs = null;
        String stmt = "SELECT departmenthistory_id,people_id,until_date FROM departmenthistory " +
        ...
        try {
            ...
            while (rs.next()) {
                DbObject dbObj;
                lst.add(dbObj=new Departmenthistory(con,new Integer(rs.getInt(1)),new Integer(rs.getInt(2)),rs.getDate(3)));
                dbObj.setNew(false);
            }
        } finally {
            try {
    ...
    public void setUntilDate(Date untilDate) throws SQLException, ForeignKeyViolationException {
